 ...
 with(as.list(c(state, parameters)), {
      ...
      input <- approxfun(signa, rule = 2)
        ...
        dose= input(t)
         ...
         dSm = lambda*(1-(Sm+Rm)/Nmmax)*Sm -eta*((L/(L+Ls50))*Sm)-a*Sm;
         dRm = (1-p)*lambda*(1-(Sm+Rm)/Nmmax)*Rm - eta*((L/(L+Lr50))*Rm)-a*Rm;
...
parms=c(sigma = 0.28,  Nmmax = 512861, d = 1.01,   Nemax = 484577,lambda = 0.25,eta = 0.4,
          c=0.05, p=0.05, a=0.17, k=0.1 , beta=0.0008 , alpha=0.16  ,gamma=0.16 ,vartheta= 0.53, delta=0.24 , Cs50=0.45 , Cr50=0.47, Ls50= 0.016, Lr50=0.05 )
